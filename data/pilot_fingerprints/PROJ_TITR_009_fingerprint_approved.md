# Fingerprint Approved: PROJ_TITR_009
...
- seed_category_id: 9
- raw_input_path: data/raw_examples/F07/PROJ_TITR_009/raw_files/dataset_deidentified.csv
...
- A3_state: DOSE-TITRATION
- A4_state: TITRATION-ADAPTIVE
...
## Detected Policies
- known_policies: ['dose_adaptation_policy=project_specific']
- missing_policies: []

## Expected Classification
- expected_terminal_state: REPAIR
- expected_q_code: N/A
- expected_action_sequence: parse->reconstruct_dose_titration->export
- fingerprint_confidence: HIGH
- unknown_field_count: 0

## Notes
Synthetic dataset for seed category 9. Golden candidate: NO.
